  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 select-none',
  {
    variants: {
      variant: {
        ...
        cfa: 'rounded-full uppercase font-bold bg-gradient-to-br from-amber-200 to-amber-400 hover:scale-[1.025] active:scale-[0.97] transition-all duration-200 text-black',
        pill: 'bg-zinc-800 shadow-sm !rounded-full !h-auto hover:bg-zinc-800/80',
      },
      size: {
